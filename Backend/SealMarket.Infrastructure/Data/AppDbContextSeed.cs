...
namespace SealMarket.Infrastructure.Data
{
    public static class AppDbContextSeed
    {
        ...
        {
            // Проверяем, есть ли уже данные (по брендам как индикатор)
            ...
            try
            {
                ...
                // 2. АККАУНТЫ (С ХЭШИРОВАННЫМИ ПАРОЛЯМИ!)
                var accounts = new List<Account>
                {
                    new(users[0].Id, "ivan95", passwordHasher.HashPassword("Password123!"),
                        "ivan@mail.com", "+79161234567", "Customer"),
                    new(users[1].Id, "anna98", passwordHasher.HashPassword("AnnaPass123!"),
                        "anna@mail.com", "+79162345678", "Customer"),
                    new(users[2].Id, "elena00", passwordHasher.HashPassword("Elena2000!"),
                        "elena@mail.com", "+79164567890", "Customer"),
                    new(users[3].Id, "admin", passwordHasher.HashPassword("Admin123!"),
                        "admin@sealmarket.com", "+79165678901", "Admin")
                };
